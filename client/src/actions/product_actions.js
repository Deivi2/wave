...
export function addProduct(dataSoSubmit) {

    console.log(dataSoSubmit,'data to submit');

    const request = axios.post(`${PRODUCT_SERVER}/article`, dataSoSubmit)
        .then(res => res.data);
